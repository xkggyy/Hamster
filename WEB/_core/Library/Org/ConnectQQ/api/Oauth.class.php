 ...
 */
namespace Org\ConnectQQ\api;
//require_once(dirname(dirname(__FILE__))."/comm/config.php");
...
class Oauth{
    ...
    function __construct(){
        $this->recorder = new \Org\ConnectQQ\api\Recorder();
        $this->urlUtils = new \Org\ConnectQQ\api\URL();
        $this->error = new \Org\ConnectQQ\api\ErrorCase();
    }
    ...
    public function qq_callback($callback){
